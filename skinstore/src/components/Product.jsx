 ...
 if(option==="discount"){
    ...
    return (
      ...
      <Flex  w='90%' margin={'auto'}>
        <Box border="solid" w="21%" mt="14" ml="2" >
        ...
        <Box w="70%">
          <Box ml="12" pt="10">
            ...
            <Text fontSize="sm">
              ...
              such as Arcona, Caudalie, Dermalogica, Elizabeth Arden, First Aid
              Beauty, Murad, Obagi, SkinCeuticals, SkinMedica, StriVectin & many
              more. Take your pick from cleansers, moisturizers, masks, serums and
              more to treat all your skincare concerns from anti-aging to acne.
            </Text>
          </Box>
          <Box>
            <Flex m="10">
              <Box>
                <Flex>
                  ...
                  <Box>
                    <Select ref={ref}  onChange={handleChangeoption}
